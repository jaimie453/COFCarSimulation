...
public class ParabolaController : MonoBehaviour
{
    ...
    /// Start of Parabola
    /// </summary>
    public GameObject ParabolaRoot = null;
    ...
    void Update()
    {
        ...
        //Debug.Log("animationTime: " + animationTime.ToString() + " getDuration(): " + parabolaFly.GetDuration());
        ...
        if (Animation && parabolaFly != null && animationTime < parabolaFly.GetDuration())
        {
            ...
            Vector3 nextPos = parabolaFly.GetPositionAtTime(animationTime);
            car.LookAt2D(nextPos);
